...
In the GCP Console, on the Navigation menu (Navigation menu), click VPC network > VPC networks.
...
In the navigation pane, click Firewall rules.
...
In the GCP Console, on the Navigation menu (Navigation menu), click VPC network > External IP addresses.
...
In the GCP Console, on the Navigation menu (Navigation menu), click Hybrid Connectivity > VPN.
